 ...
 function handleFileSelect()
  {      
    ...
    if (!input) {
      ...
      file = input.files[0];
      uploadToServerRecordedFile(file, function(){
        ...
        */
        ...
        if ((isIE && hasFlash == false) || (isFirefox && hasFlash == false)) {
            ...
            if (isIE && isIeLessThan9) {
                document.getElementById('flashCamContainer').innerHTML = '<object type="application/x-shockwave-flash" name="' + attributes["name"] + '" id="' + attributes["id"] + '" align="' + attributes["align"] + '" width="' + size["width"] + '" height="' + size["height"] + '"><param name="quality" value="' + params["quality"] + '"><param name="bgcolor" value="' + params["bgcolor"] + '"><param name="play" value="' + params["play"] + '"><param name="loop" value="' + params["loop"] + '"><param name="allowscriptaccess" value="' + params["allowscriptaccess"] + '"><param name="wmode" value="' + params["wmode"] + '"><param name="flashvars" value="' + flashVarsString + '"><param name="movie" value="assets/js/video-recorder/VideoRecorder.swf"</object> ';
            } else {
                document.getElementById('flashCamContainer').innerHTML = '<object type="application/x-shockwave-flash" name="' + attributes["name"] + '" id="' + attributes["id"] + '" align="' + attributes["align"] + '" data="assets/js/video-recorder/VideoRecorder.swf" width="' + size["width"] + '" height="' + size["height"] + '"><param name="quality" value="' + params["quality"] + '"> <param name="bgcolor" value="' + params["bgcolor"] + '"><param name="play" value="' + params["play"] + '"><param name="loop" value="' + params["loop"] + '"><param name="allowscriptaccess" value="' + params["allowscriptaccess"] + '"><param name="wmode" value="' + params["wmode"] + '"><param name="flashvars" value="' + flashVarsString + '"></object> ';
            }
        }
    } else {
        document.getElementById('flashCamContainer').innerHTML = '<div id="hdfvr-content" style="width:400px;margin:auto;"><form enctype="multipart/form-data" id="hdfvr-recording-form"><input type="file" id="fileinput"/><input type="button" id="btnLoad" value="Load" onclick="handleFileSelect();"></form><img src="loaderb16.gif" id="hdfvr-loading-img" alt="Uploading please wait..."/><div id="output"></div></div>';
    }
